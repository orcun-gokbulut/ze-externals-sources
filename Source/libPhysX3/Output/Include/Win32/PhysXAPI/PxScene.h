...
//@{
	...
	*/
	...
	\note If the actor is a PxParticleSystem or PxParticleFluid and the simulation is running the operation will fail and the 
	call will return false. 

	<b>Sleeping:</b> This call wakes the actor if they are sleeping.
...
// PX_AGGREGATE
	...
	*/
	...
	@see PxAggregate
	*/
	virtual	bool						removeAggregate(PxAggregate& aggregate)	= 0;

	virtual			PxU32							getNbAggregates()	const	= 0;
	virtual			PxU32							getAggregates(PxAggregate** userBuffer, PxU32 bufferSize)	const	= 0;
///~PX_AGGREGATE
...
//@{
	...
	*/
	...
	@see getNbActors()
	*/
	virtual	PxU32						getActors(PxActorTypeSelectionFlags types, PxActor** userBuffer, PxU32 bufferSize) const	= 0;
	...
	*/
	virtual	PxU32						getArticulations(PxArticulation** userBuffer, PxU32 bufferSize) const = 0;
	...
	*/
	virtual	PxU32						getConstraints(PxConstraint** userBuffer, PxU32 bufferSize) const = 0;
	...
	*/
	virtual	PxU32						getAttachments(PxAttachment** userBuffer, PxU32 bufferSize) const = 0;
...
/************************************************************************************************/
	...
	should be subdivided into smaller time intervals and the simulate() should be called
	...
	*/
	virtual	void						simulate(PxReal elapsedTime, physx::pxtask::BaseTask *completionTask = NULL)		= 0;
	...
	*/
	virtual	PxSweepCache*				createSweepCache(PxReal dimensions = 5.0f) = 0;
	...
	*/
	virtual bool raycastAny(const PxVec3& origin, const PxVec3& unitDir, const PxReal distance,
							...
							const PxSceneQueryCache* cache = NULL) = 0;
	...
	*/
	virtual bool overlapAny(const PxGeometry& geometry,
							...
							PxShape*& hit,
							const PxSceneQueryFilterData& filterData = PxSceneQueryFilterData(),
							PxSceneQueryFilterCallback* filterCall = NULL) = 0;
