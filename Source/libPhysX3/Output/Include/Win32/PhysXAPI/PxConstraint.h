...
public:
	...
	*/
	...
	virtual	void				setBreakImpulse(PxReal linear, PxReal angular)					= 0;
	...
	*/
	virtual	void				getBreakImpulse(PxReal& linear, PxReal& angular)		const	= 0;
	...
	*/
	...
	\param[in] solverPrep the solver constraint generation function
	\param[in] solverPrepSpu the spu-optimized solver constraint generation function
	\param[in] solverPrepSpuByteSize the code size of the spu-optimized solver constraint generatin function
	\param[in] project the constraint projection function
	\param[in] visualize the constraint visualization function
	...
	*/
	virtual	void				setConstraintFunctions(PxConstraintConnector* connector,
													   ...
													   PxConstraintVisualize visualize)		= 0;
