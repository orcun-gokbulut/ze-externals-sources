...
public:
	...
	*/
	...
	@see restOffset PxDeformable.setContactOffset() PxShapeDesc.contactOffset
	*/
	...
	@see contactOffset PxDeformable.setRestOffset() PxShapeDesc.restOffset
	*/
	PxReal restOffset;
