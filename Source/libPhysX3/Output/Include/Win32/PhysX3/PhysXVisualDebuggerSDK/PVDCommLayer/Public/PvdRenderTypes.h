...
namespace PVD { 
	...
	public:
		...
		PX_INLINE RenderTransform(RenderTransformType inType, const RenderTransformData& inData ) : mType( inType ), mData( inData ) {}
	...
	public:
		...
		RenderPrimitive( RenderPrimitiveType inType, RenderPrimitiveData inData ) : mType( inType ), mData( inData ){}
		RenderPrimitive( const RenderPrimitive& inOther ) : mType( inOther.mType ), mData( inOther.mData ) {}
