...
public:
	/**
	\brief the range beyond which the limit is active. The upper limit must be now lower than the
	...
	*/
	...
	/**
	\brief Construct a joint limit pair
...
/**
\brief Describes an elliptical conical joint limit. Note that very small or highly elliptical limit cones may result in jitter.
...
public:
	/**
	\brief the angle from the Y axis of the constraint frame position beyond which the limit is active.
	...
	*/
	...
	/**
	\brief the angle from the Z-axis of the constraint frame beyond which the limit is active.
