...
public:
	...
	*/
	...
	virtual void				setLocalPose(PxU32 actor, const PxTransform& localPose)			= 0;
	...
	*/
	...
	virtual PxTransform			getLocalPose(PxU32 actor)								const	= 0;
...
PX_C_EXPORT /*PX_PHYSX_CORE_API*/ void PX_CALL_CONV PxSetJointGlobalFrame(PxJoint& joint, const PxVec3* wsAnchor, const PxVec3* wsAxis);
