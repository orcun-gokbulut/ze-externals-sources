...
public:
	...
	*/
	/*PX_PHYSX_CORE_API*/ static		bool			updateMassAndInertia(PxRigidBody& body, PxReal density, const PxVec3* massLocalPose = NULL);
	...
	*/
	/*PX_PHYSX_CORE_API*/ static		bool			setMassAndUpdateInertia(PxRigidBody& body, PxReal mass, const PxVec3* massLocalPose = NULL);
	...
	*/
	/*PX_PHYSX_CORE_API*/ static		void			addForceAtPos(PxRigidBody& body, const PxVec3& force, const PxVec3& pos, PxForceMode::Enum mode = PxForceMode::eFORCE, bool wakeup = true);
	...
	*/
	/*PX_PHYSX_CORE_API*/ static		void			addForceAtLocalPos(PxRigidBody& body, const PxVec3& force, const PxVec3& pos, PxForceMode::Enum mode = PxForceMode::eFORCE, bool wakeup = true);
	...
	*/
	/*PX_PHYSX_CORE_API*/ static		void			addLocalForceAtPos(PxRigidBody& body, const PxVec3& force, const PxVec3& pos, PxForceMode::Enum mode = PxForceMode::eFORCE, bool wakeup = true);
	...
	*/
	/*PX_PHYSX_CORE_API*/ static		void			addLocalForceAtLocalPos(PxRigidBody& body, const PxVec3& force, const PxVec3& pos, PxForceMode::Enum mode = PxForceMode::eFORCE, bool wakeup = true);
	...
	*/
	/*PX_PHYSX_CORE_API*/ static		PxVec3			getPointVelocity(PxRigidBody& body, const PxVec3& point);
	...
	*/
	/*PX_PHYSX_CORE_API*/ static		void			linearSweepSingle(PxRigidBody& body, PxBatchQuery& batchQuery, const PxVec3& unitDir, const PxReal distance, PxSceneQueryFilterFlags filterFlags, bool useShapeFilterData = true, PxFilterData* filterDataList=NULL, PxU32 filterDataCount=0, void* userData=NULL, const PxSweepCache* sweepCache=NULL);
