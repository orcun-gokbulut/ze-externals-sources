...
struct PxPairFlag
{
	enum Enum
	{
		...
		*/
		...
		Once the shapes come into contact, no further swept integration checks are performed until they separate.  For small objects which continue to have a tendency
		to inter penetrate after the first high velocity impact, eSWEPT_CONTACT_GENERATION should also be specified to prevent subsequent tunneling.
...
@see PxShapeDesc.simulationFilterData PxDeformableDesc.simulationFilterData PxParticleBaseDesc.simulationFilterData PxSimulationFilterShader PxSimulationFilterCallback
*/
struct PxFilterData
{
