...
struct EqualityOp
{
	...
	template<PxPropertyInfoName::Enum TKey, typename TObjType>
	...
	//a stack overflow.
	void operator()( const PxReadOnlyPropertyInfo<PxPropertyInfoName::PxActor_RigidStatic, PxActor, const PxRigidStatic * >& inProp, PxU32 ) {}
	void operator()( const PxReadOnlyPropertyInfo<PxPropertyInfoName::PxActor_RigidDynamic, PxActor, const PxRigidDynamic * >& inProp, PxU32 ) {}
	void operator()( const PxReadOnlyPropertyInfo<PxPropertyInfoName::PxActor_ParticleSystem, PxActor, const PxParticleSystem * >& inProp, PxU32 ) {}
	void operator()( const PxReadOnlyPropertyInfo<PxPropertyInfoName::PxActor_ParticleFluid, PxActor, const PxParticleFluid * >& inProp, PxU32 ) {}
	void operator()( const PxReadOnlyPropertyInfo<PxPropertyInfoName::PxActor_Deformable, PxActor, const PxDeformable * >& inProp, PxU32 ) {}
	void operator()( const PxReadOnlyPropertyInfo<PxPropertyInfoName::PxActor_ArticulationLink, PxActor, const PxArticulationLink * >& inProp, PxU32 ) {}

	//Children is unnecessary and articulation points back to the source.
	void operator()( const PxReadOnlyPropertyInfo<PxPropertyInfoName::PxArticulationLink_Articulation, PxArticulationLink, PxArticulation & >& inProp, PxU32 ) {}
	...
	void operator()( const PxReadOnlyPropertyInfo<PxPropertyInfoName::PxShape_Actor, PxShape, PxRigidActor & >& inProp, PxU32 ) {}
	
	template<PxPropertyInfoName::Enum TKey, typename TObjType, typename TGetPropType>
	...
	template<PxPropertyInfoName::Enum TKey, typename TObjType, typename TPropType>
	...
	template<PxPropertyInfoName::Enum TKey, typename TObjType, typename TIndexType, typename TPropType>
	...
	template<PxPropertyInfoName::Enum TKey, typename TObjType, typename TCollectionType>
	...
	template<PxPropertyInfoName::Enum TKey, typename TObjType, typename TFilterType, typename TCollectionType>
