...
namespace PVD
{
	...
	struct PvdConnectionEventType
	{
		enum
		{
			...
			MultipleEvent, //A multiple events of the same type.
	...
	struct SStreamInitialization
	{
		...
		static const PxU32 sCurrentStreamVersion = 6;
	...
	{ 
		...
		SStreamInitialization retval = { 0xDEADBEEF, SStreamInitialization::sCurrentStreamVersion, conversion.mNumerator, conversion.mDenominator }; 
		return retval; 
	}
