...
@see PxRigidDynamicDesc, PxRigidDynamic.setRigidDynamicFlag(), PxRigidDynamic.getRigidDynamicFlags()
*/
...
*/
	...
	@see PxRigidDynamicFlag setRigidDynamicFlag() PxRigidDynamicDesc.rigidDynamicFlags
	*/
...
*/
	...
	@see getLinearDamping() setAngularDamping() PxRigidDynamicDesc.linearDamping
	*/
	...
	@see setLinearDamping() getAngularDamping() PxRigidDynamicDesc.linearDamping
	*/
	...
	@see getAngularDamping() PxRigidDynamicDesc.angularDamping setLinearDamping()
	*/
	...
	@see setAngularDamping() PxRigidDynamicDesc.angularDamping getLinearDamping()
	*/
...
*/
	...
	@see getMaxAngularVelocity() PxRigidDynamicDesc.maxAngularVelocity
	*/
	...
	@see setMaxAngularVelocity PxRigidDynamicDesc.maxAngularVelocity
	*/
...
*/
	...
	@see isSleeping() wakeUp() putToSleep()  getSleepEnergyThreshold()
	*/
	...
	Actors whose energy divided by mass is above this threshold will not be put to sleep.

	\note although this function refers to 'energy', it is actually kinetic energy divided by mass.

	\param[in] threshold Energy below which an actor may go to sleep. <b>Range:</b> (0,inf]

	@see isSleeping() getSleepEnergyThreshold() wakeUp() putToSleep()
	*/
	virtual		void				setSleepEnergyThreshold(PxReal threshold) = 0;
	...
	\note although this function refers to 'energy', the quantity is actually kinetic energy divided by mass.

	\return The energy threshold for sleeping.

	@see isSleeping() wakeUp() putToSleep() setSleepEnergyThreshold()
	*/
	virtual		PxReal				getSleepEnergyThreshold() const = 0;
...
/************************************************************************************************/
	...
	@see getSolverIterationCounts() PxRigidDynamicDesc.minPositionIterations PxRigidDynamicDesc.minVelocityIterations
	*/
	...
	@see setSolverIterationCounts() PxRigidDynamicDesc.minPositionIterations PxRigidDynamicDesc.minVelocityIterations
	*/
	...
	@see setContactReportThreshold PxRigidDynamicDesc::contactReportThreshold PxPairFlag PxSimulationFilterShader PxSimulationFilterCallback
	*/
	...
	@see getContactReportThreshold PxRigidDynamicDesc::contactReportThreshold PxPairFlag
	*/
	...
	@see PxRigidDynamicFlag getRigidDynamicFlags() PxRigidDynamicDesc.rigidDynamicFlags
	*/
	...
	@see PxRigidDynamicFlag setRigidDynamicFlag() PxRigidDynamicDesc.rigidBodyFlags
	*/
