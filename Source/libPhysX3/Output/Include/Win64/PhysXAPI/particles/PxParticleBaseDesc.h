...
public:
	...
	*/
	...
	@see restOffset PxParticleBase.getContactOffset() PxShapeDesc.contactOffset
	*/
	...
	@see contactOffset thickness PxParticleBase.getRestOffset() PxShapeDesc.restOffset PxParticleBaseFlag.ePER_PARTICLE_REST_OFFSET
	*/
	PxReal restOffset;
