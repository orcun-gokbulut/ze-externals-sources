...
namespace physx { namespace repx {
	...
	template<> PX_INLINE const char* getItemName<const PxShapeDesc>() { return "PxShape"; }
	template<> PX_INLINE const char* getItemName<PxMaterial>() { return "PxMaterialRef"; }
	template<> PX_INLINE const char* getItemName<PxArticulationLinkDesc>() { return "PxArticulationLink"; }
