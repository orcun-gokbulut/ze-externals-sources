...
//~PX_SERIALIZATION
	...
	The height field remains in	existence until simulation shapes referencing it are destroyed. Be sure to not keep a reference to this 
	...
	*/
	...
	/**
	\brief Returns number of shapes referencing the mesh.
