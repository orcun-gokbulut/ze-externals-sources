...
*/
	...
	@see PxRigidDynamic.setLinearVelocity() getAngularVelocity() PxRigidDynamicDesc.linearVelocity
	*/
	...
	@see getLinearVelocity() setAngularVelocity() PxRigidDynamicDesc.linearVelocity
	*/
	...
	@see PxRigidDynamic.setAngularVelocity() getLinearVelocity() PxRigidDynamicDesc.angularVelocity
	*/
	...
	@see getAngularVelocity() setLinearVelocity() PxRigidDynamicDesc.angularVelocity
	*/
...
*/
	...
	\note The force modes ::eIMPULSE and ::eVELOCITY_CHANGE can not be applied to articulation links
