...
*/
	...
	PX_DEPRECATED virtual		PxShape*		createShape(const PxShapeDesc& desc) = 0;
	...
	*/
	...
	virtual		PxShape*		createShape(const PxGeometry& geometry, PxMaterial& material, const PxTransform& localPose = PxTransform::createIdentity()) = 0;
	...
	\param[in] relativePose optional actor-relative pose of the shape 
	...
	*/
	...
	virtual		PxShape*		createShape(const PxGeometry& geometry, PxMaterial *const* materials, PxU32 materialCount, const PxTransform& relativePose = PxTransform::createIdentity()) = 0;
	...
	*/
	virtual		PxU32			getShapes(PxShape** userBuffer, PxU32 bufferSize)			const	= 0;
