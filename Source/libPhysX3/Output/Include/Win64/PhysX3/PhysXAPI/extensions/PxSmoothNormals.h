...
#include "common/PxPhysXCommon.h"
	...
	*/
	PX_C_EXPORT bool PX_CALL_CONV PxBuildSmoothNormals(PxU32 nbTris, PxU32 nbVerts, const PxVec3* verts, const PxU32* dFaces, const PxU16* wFaces, PxVec3* normals, bool flip);
