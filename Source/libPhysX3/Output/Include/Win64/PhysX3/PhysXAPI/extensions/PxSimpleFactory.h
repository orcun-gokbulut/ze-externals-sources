...
PX_C_EXPORT	PxRigidDynamic*	PX_CALL_CONV	PxCreateDynamic(PxPhysics& sdk, 
															const PxTransform& transform, 
															const PxGeometry& geometry, 
															PxMaterial& material, 
															PxReal density,
															const PxTransform &shapeOffset = PxTransform::createIdentity());
...
PX_C_EXPORT	PxRigidDynamic*	PX_CALL_CONV	PxCreateKinematic(PxPhysics& sdk, 
															  const PxTransform& transform, 
															  const PxGeometry& geometry, 
															  PxMaterial& material,
															  PxReal density,
...
PX_C_EXPORT	PxRigidStatic*	PX_CALL_CONV	PxCreateStatic(PxPhysics& sdk, 
														   const PxTransform& transform, 
														   const PxGeometry& geometry, 
														   PxMaterial& material,
														   const PxTransform &shapeOffset = PxTransform::createIdentity());
