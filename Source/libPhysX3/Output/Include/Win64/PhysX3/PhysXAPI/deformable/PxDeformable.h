...
class PxDeformable : public PxActor
{
protected:
// PX_SERIALIZATION
...
public:
	...
	*/
	...
	If the threshold value is negative,	the velocity threshold is set using the PxPhysics's 
	PX_DEFAULT_SLEEP_LIN_VEL_SQUARED parameter.
