...
namespace PVD { 
	...
	public:
		...
		RenderCommand( RenderCommandType inType, RenderCommandData inData ) : mType( inType ), mData( inData ) {}
		RenderCommand( const RenderCommand& inOther ) : mType( inOther.mType ), mData( inOther.mData ) {}
