...
namespace physx { namespace repx {
	...
	{
		if ( physx::string::stricmp( inRepXExtensionName, getExtensionNameForType( (PxD6Joint*)NULL ) ) == 0 )
			return inOperator( inId, reinterpret_cast<PxD6Joint*>( inLiveObject ) );
		else if ( physx::string::stricmp( inRepXExtensionName, getExtensionNameForType( (PxDistanceJoint*)NULL ) ) == 0 )
			return inOperator( inId, reinterpret_cast<PxDistanceJoint*>( inLiveObject ) );
		else if ( physx::string::stricmp( inRepXExtensionName, getExtensionNameForType( (PxFixedJoint*)NULL ) ) == 0 )
			return inOperator( inId, reinterpret_cast<PxFixedJoint*>( inLiveObject ) );
		else if ( physx::string::stricmp( inRepXExtensionName, getExtensionNameForType( (PxPrismaticJoint*)NULL ) ) == 0 )
			return inOperator( inId, reinterpret_cast<PxPrismaticJoint*>( inLiveObject ) );
		else if ( physx::string::stricmp( inRepXExtensionName, getExtensionNameForType( (PxRevoluteJoint*)NULL ) ) == 0 )
			return inOperator( inId, reinterpret_cast<PxRevoluteJoint*>( inLiveObject ) );
		else if ( physx::string::stricmp( inRepXExtensionName, getExtensionNameForType( (PxSphericalJoint*)NULL ) ) == 0 )
