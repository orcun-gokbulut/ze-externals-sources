...
public:
	...
	\param[in] actor The potentially hit actor
	...
	*/
	virtual PxSceneQueryHitType::Enum preFilter(const PxFilterData& filterData, PxShape* shape, PxActor* actor, PxSceneQueryFilterFlags& filterFlags) = 0;
