...
PX_C_EXPORT /*PX_PHYSX_CORE_API*/ bool PX_CALL_CONV PxInitExtensions(PxPhysics &physics);
...
PX_C_EXPORT /*PX_PHYSX_CORE_API*/ void PX_CALL_CONV PxCloseExtensions();
...
PX_C_EXPORT /*PX_PHYSX_CORE_API*/ bool PX_CALL_CONV PxDumpMetaData(const char* filename, const PxPhysics& sdk);
...
then be serialied. Collected objects include materials, convex meshes, triangle meshes, heightfields
...
\param[in] sdk The physics SDK object to be exported.  See #PxPhysics
\param[in] collection Collection to which objects will be added. See #PxCollection

@see PxCollection
*/
PX_C_EXPORT /*PX_PHYSX_CORE_API*/ void PxCollectForExportSDK(const PxPhysics& sdk, PxCollection& collection);
...
@see PxCollection
*/
PX_C_EXPORT /*PX_PHYSX_CORE_API*/ void PxCollectForExportScene(const PxScene& scene, PxCollection& collection);
