...
public:
	...
	\param[in] validParticleBitmap	???
	\param[in] lastValidParticleIndex	???
	...
	*/
	/*PX_PHYSX_CORE_API*/ static PxU32 buildBoundsHash(PxU32* sortedParticleIndices,
												ParticleBounds* particleBounds,
												const PxStrideIterator<const PxVec3>& positionBuffer,
												const PxU32* validParticleBitmap,
												const PxU32 lastValidParticleIndex,
