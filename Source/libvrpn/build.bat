...
mkdir Build
cd Build
cmake -D CMAKE_INSTALL_PREFIX:PATH="Output" -D VRPN_BUILD_CLIENTS:BOOL="0" -D VRPN_BUILD_SERVER_LIBRARY:BOOL="0" -D VRPN_BUILD_SERVERS:BOOL="0" -G "Visual Studio 9 2008" ../Source"
...
mkdir Build
cd Build
cmake -D CMAKE_INSTALL_PREFIX:PATH="Output" -D VRPN_BUILD_CLIENTS:BOOL="0" -D VRPN_BUILD_SERVER_LIBRARY:BOOL="0" -D VRPN_BUILD_SERVERS:BOOL="0" -G "Visual Studio 9 2008 Win64" ../Source"
if %ERRORLEVEL% NEQ 0 GOTO Error
