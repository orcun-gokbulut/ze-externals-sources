...
if %ERRORLEVEL% NEQ 0 GOTO Error
xcopy /r /y Source\ports\MSVC++\2008\Release\libmpg123.lib Output\Lib\Win32\
xcopy /r /y Source\ports\MSVC++\2008\Release\libmpg123.dll Output\Dll\Win32\
...
if %ERRORLEVEL% NEQ 0 GOTO Error
xcopy /r /y Source\ports\MSVC++\2008\Release\libmpg123.lib Output\Lib\Win64\
xcopy /r /y Source\ports\MSVC++\2008\Release\libmpg123.dll Output\Dll\Win64\
